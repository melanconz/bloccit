 ...
 RSpec.describe SponsoredPostsController do
   ...
   describe "SPONSORED_POST create" do
     it "increases the number of SponsoredPost by 1" do
       expect{sponsored_post :create, topic_id: my_topic.id, sponsored_post: {name: RandomData.random_sentence, description: RandomData.random_paragraph}}.to change(SponsoredPost,:count).by(1)
     end

     it "assigns sponsored_post.last to @sponsored_post" do
     ...
     it "redirects to the new sponsored_post" do
       sponsored_post :create, topic_id: my_topic.id, sponsored_post: {name: RandomData.random_sentence, description: RandomData.random_paragraph}
